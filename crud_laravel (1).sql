...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Jun-2022 às 15:16
...
INSERT INTO `carros` (`id`, `nome`, `preco`, `created_at`, `updated_at`) VALUES
(2, 'Gol', 10000.00, '2022-06-01 16:01:04', '2022-06-20 12:57:06'),
(3, 'Marea', 15000.00, '2022-06-01 16:01:14', '2022-06-20 12:58:31'),
(5, 'Golf', 80000.00, '2022-06-20 15:59:00', '2022-06-20 12:59:00');
...
INSERT INTO `pessoas` (`id`, `nome`, `nascimento`, `carro`, `cidade`, `created_at`, `updated_at`) VALUES
('3', 'Jao', '2022-06-24', 2, 2, '2022-06-20 16:15:48', '2022-06-20 13:15:48');
...
--
ALTER TABLE `pessoas`
  ADD CONSTRAINT `pessoas_ibfk_1` FOREIGN KEY (`carro`) REFERENCES `carros` (`id`),
